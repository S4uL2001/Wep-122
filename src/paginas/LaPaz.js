...
const LaPaz = () => {
  return (
    <div className="container mt-5">
      <h1 className="text-center mb-4">La Paz</h1>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <h3>Centro de Salud "Vida Saludable" en La Paz</h3>
          <p>
          Bienvenido a nuestro Centro de Salud "Vida Saludable", ubicado en el corazón de la ciudad de La Paz. Nos enorgullece ser un oasis de bienestar, comprometidos a proporcionar atención médica integral y accesible para toda la comunidad paceña.
          </p>
          ...
          <p>
            Nos esforzamos por ser un pilar en la comunidad paceña, colaborando con organizaciones locales, participando en eventos comunitarios y trabajando juntos para construir un entorno más saludable.
          </p>
        </div>
      </div>
